...
{
    public partial class CircleLineFixPos3DView : UserControl
    {
        private CircleLineFixPos3DModel _fixPos;

        public CircleLineFixPos3DView(CircleLineFixPos3DModel fixPos)
        {
            InitializeComponent();
            _fixPos = fixPos;
        }
        ...
        public override void Refresh()
        {
            ...
            CbB_Direction1.SelectedIndex = _fixPos.Direction2;
        ...
        private void UpdateValue()
        {
            try
            {
                ...
                _fixPos.Direction1 = CbB_Direction1.SelectedIndex;
