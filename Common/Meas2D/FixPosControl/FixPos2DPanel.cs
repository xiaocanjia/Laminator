...
{
    public partial class FixPos2DPanel : UserControl
    {
        private FixPos2DManager _manager;

        public FixPos2DPanel()
        {
            InitializeComponent();
        }

        public void Init(FixPos2DManager manager)
        {
            _manager = manager;
        ...
        private void OpenSetupPanel(FixPos2DBaseModel fixPos)
        {
        ...
        private void CloseSetupPanel(FixPos2DBaseModel fixPos)
        {
            Panel_Setup.Visible = false;
            Panel_Setup.Controls.Clear();
